...
<?php $__env->startSection('title', 'Dashboard - SENA Control de Asistencia'); ?>
        ...
        <div class="stat-card delay-100">
            <div class="stat-card-header">
                <div>
                    ...
                    <div class="stat-card-value"><?php echo e($estadisticas['total_aprendices']); ?></div>
                </div>
        ...
        <div class="stat-card delay-200">
            <div class="stat-card-header">
                <div>
                    ...
                    <div class="stat-card-value"><?php echo e($estadisticas['asistencias_hoy']); ?></div>
                </div>
                <div class="stat-card-icon">
            ...
            <div class="stat-card-trend">
                ...
                <span><?php echo e($estadisticas['porcentaje_asistencia_hoy']); ?>% de asistencia</span>
            </div>
        </div>
        ...
        <div class="stat-card delay-300">
            <div class="stat-card-header">
                <div>
                    ...
                    <div class="stat-card-value"><?php echo e($estadisticas['porcentaje_tardanzas']); ?>%</div>
                </div>
                <div class="stat-card-icon">
        ...
        <div class="stat-card delay-400">
            <div class="stat-card-header">
                <div>
                    ...
                    <div class="stat-card-value"><?php echo e($estadisticas['tendencia_semanal'] > 0 ? '+' : ''); ?><?php echo e($estadisticas['tendencia_semanal']); ?>%</div>
                </div>
                <div class="stat-card-icon">
                    <i class="fas fa-chart-line"></i>
                </div>
            </div>
            <div class="stat-card-trend <?php echo e($estadisticas['tendencia_semanal'] >= 0 ? 'trend-up' : 'trend-down'); ?>">
                <i class="fas fa-<?php echo e($estadisticas['tendencia_semanal'] >= 0 ? 'arrow-up' : 'arrow-down'); ?>" style="margin-right: 4px;"></i>
...
<script>
    ...
    function cargarEstadisticasGraficos() {
        $.ajax({
            url: '<?php echo e(route("admin.estadisticas.graficos")); ?>',
            method: 'GET',
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ersena\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>