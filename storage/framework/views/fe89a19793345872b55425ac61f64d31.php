...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('img/icon/icono.ico')); ?>" type="image/ico">
</head>
<body>
    <!-- Botón de menú móvil -->
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <div class="user-profile">
                ...
                <div class="profile-image">
                    <img src="<?php echo e($user->profile_photo ?? asset('img/default/sena.png')); ?>" 
                         alt="Foto de perfil" 
                         id="profileImage">
                    <input type="file" id="foto_perfil" name="foto_perfil" accept="image/*" style="display: none;">
                </div>
                <div class="user-info">
                    <h3><?php echo e(explode(' ', $user->nombres_completos)[0]); ?></h3>
                    <p>Aprendiz SENA</p>
                </div>
            </div>
        ...
        <main class="main-content">
            ...
            <section id="dashboard" class="content-section active">
                <div class="section-header">
                    <h1>Bienvenido, <?php echo e(explode(' ', $user->nombres_completos)[0]); ?></h1>
                    <p class="text-muted"><?php echo e(now()->locale('es')->isoFormat('dddd, D [de] MMMM')); ?></p>
                    <?php if($programa && $programa->jornada): ?>
                        <div class="schedule-info">
                            <i class="fas fa-clock"></i>
                            Entrada: <?php echo e(\Carbon\Carbon::parse($programa->jornada->hora_entrada)->format('h:i A')); ?>

                            <span class="tolerance-badge" title="Tolerancia">
                                <i class="fas fa-hourglass-half"></i>
                                <?php echo e(\Carbon\Carbon::parse($programa->jornada->tolerancia)->format('i')); ?> min
                            </span>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="dashboard-grid">
                    ...
                    <div class="dashboard-card status-card <?php echo e($estadoActual === 'dentro' ? 'success' : 'neutral'); ?>">
                        <div class="card-header">
                            <div class="card-icon pulse">
                                <i class="fas fa-<?php echo e($estadoActual === 'dentro' ? 'user-check' : 'user'); ?>"></i>
                            </div>
                            <h3>Estado Actual</h3>
                        </div>
                        <div class="status-content">
                            <div class="status-badge <?php echo e($estadoActual === 'dentro' ? 'success' : 'neutral'); ?>">
                                <i class="fas fa-<?php echo e($estadoActual === 'dentro' ? 'check-circle' : 'clock'); ?>"></i>
                                <?php echo e($estadoActual === 'dentro' ? 'En el SENA' : 'Fuera del SENA'); ?>

                            </div>
                            <?php if($ultimoRegistro): ?>
                                <div class="time-info">
                                    <span class="time-label">Desde:</span>
                                    <span class="time-value"><?php echo e($ultimoRegistro->fecha_hora->format('h:i A')); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="dashboard-card">
                        ...
                        <div class="stats-grid">
                            <div class="stat-item">
                                <div class="stat-value"><?php echo e($registrosRecientes->where('tipo', 'entrada')->count()); ?></div>
                                ...
                                <div class="stat-value">
                                    <?php
                                        $puntualidad = $registrosRecientes->where('tipo', 'entrada')->count() > 0 
                                            ...
                                            : 0;
                                    ?>
                                    <?php echo e($puntualidad); ?>%
                                </div>
                                <div class="stat-label">Puntualidad</div>
                            </div>
                            <div class="stat-item">
                                <div class="stat-value"><?php echo e($registrosRecientes->count()); ?></div>
                            ...
                            <div class="program-info">
                                <div class="info-grid">
                                    <div class="info-item">
                                        ...
                                        <div class="info-value"><?php echo e($programa->nombre_programa); ?></div>
                                    </div>
                                    <div class="info-item">
                                        <div class="info-label"><i class="fas fa-hashtag"></i> Ficha</div>
                                        <div class="info-value"><?php echo e($programa->numero_ficha); ?></div>
                                    </div>
                                    <div class="info-item">
                                        <div class="info-label"><i class="fas fa-door-open"></i> Ambiente</div>
                                        <div class="info-value"><?php echo e($programa->numero_ambiente); ?></div>
                                    </div>
                                    <div class="info-item">
                                        <div class="info-label"><i class="fas fa-layer-group"></i> Nivel</div>
                                        <div class="info-value text-capitalize"><?php echo e($programa->nivel_formacion); ?></div>
                                    </div>
                                </div>
                            </div>
                        <?php else: ?>
                ...
                <div class="records-container">
                    ...
                    <div class="records-list">
                        <?php $__empty_1 = true; $__currentLoopData = $registrosRecientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="record-item <?php echo e($registro->tipo); ?>">
                                <div class="record-icon">
                                    <i class="fas fa-sign-<?php echo e($registro->tipo === 'entrada' ? 'in' : 'out'); ?>-alt"></i>
                                </div>
                                <div class="record-info">
                                    <div class="record-title">
                                        <?php echo e($registro->tipo === 'entrada' ? 'Entrada' : 'Salida'); ?>
                                        ...
                                        <?php if($registro->tipo === 'entrada'): ?>
                                            <span class="punctuality-badge <?php echo e($esPuntual ? 'on-time' : 'late'); ?>" 
                                                  title="<?php echo e($esPuntual ? 'Llegada puntual' : 'Llegada tarde'); ?>">
                                                <i class="fas fa-<?php echo e($esPuntual ? 'check' : 'exclamation'); ?>"></i>
                                            </span>
                                        <?php endif; ?>
                                    </div>
                                    <div class="record-subtitle">
                                        <span class="date"><?php echo e($registro->fecha_hora->format('d/m/Y')); ?></span>
                                        <span class="time"><?php echo e($registro->fecha_hora->format('h:i A')); ?></span>
                                    </div>
                                </div>
                                <div class="status-badge <?php echo e($registro->tipo === 'entrada' ? 'success' : 'danger'); ?>">
                                    <?php echo e($registro->tipo === 'entrada' ? 'Entrada' : 'Salida'); ?>
            ...
            <section id="registros" class="content-section">
                <div class="section-header">
                    ...
                    <div class="date-filters">
                        <input type="date" id="fecha_inicio" class="filter-input" value="<?php echo e(now()->subMonth()->format('Y-m-d')); ?>">
                        <input type="date" id="fecha_fin" class="filter-input" value="<?php echo e(now()->format('Y-m-d')); ?>">
                    ...
                    <div class="records-list" id="lista-registros">
                        <?php $__currentLoopData = $registros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="record-item">
                                ...
                                <div class="record-info">
                                    <div class="record-title"><?php echo e($registro->tipo === 'entrada' ? 'Entrada' : 'Salida'); ?></div>
                                    <div class="record-subtitle"><?php echo e($registro->fecha_hora->format('d/m/Y h:i A')); ?></div>
                                </div>
                                <div class="status-badge <?php echo e($registro->tipo === 'entrada' ? 'success' : 'danger'); ?>">
                                    <?php echo e($registro->tipo === 'entrada' ? 'Entrada' : 'Salida'); ?>
                            ...
                            <div class="device-info">
                                <div class="info-grid">
                                    <div class="info-item">
                                        ...
                                        <div class="info-value"><?php echo e($device->serial); ?></div>
                                    </div>
                                </div>
                                <div class="device-image-container">
                                    <div class="device-image">
                                        <img src="<?php echo e($device->foto_serial); ?>" 
                                             alt="Foto Serial <?php echo e($device->marca); ?>"
                                             loading="lazy"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Generar QR
        const qrCode = '<?php echo e($user->qr_code); ?>';
        ...
        if (inputFotoPerfil) {
            inputFotoPerfil.addEventListener('change', async function(e) {
                ...
                // Enviar al servidor
                try {
                    const response = await fetch('<?php echo e(route("aprendiz.actualizar-foto")); ?>', {
                        method: 'POST',
    ...
    async function filtrarRegistros() {
        ...
        try {
            const response = await fetch('<?php echo e(route("aprendiz.filtrar-registros")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
</html><?php /**PATH C:\laragon\www\ersena\resources\views/aprendiz/dashboard.blade.php ENDPATH**/ ?>