...
<script>
    ...
    function buscarAprendizPorQR(qrCode) {
        $.ajax({
            url: '<?php echo e(route("admin.buscar-por-qr")); ?>',
            method: 'POST',
            data: {
                qr_code: qrCode
            },
    ...
    function verificarAsistencia(documento) {
        $.ajax({
            url: '<?php echo e(route("admin.verificar-asistencia")); ?>',
            method: 'POST',
            data: {
    ...
    function registrarAsistencia(tipo) {
        ...
        $.ajax({
            url: '<?php echo e(route("admin.registrar-asistencia")); ?>',
            method: 'POST',
            data: {
                documento_identidad: documento,
                tipo: tipo
...
<?php $__env->stopSection(); ?> <?php /**PATH C:\laragon\www\ersena\resources\views/admin/partials/scanner.blade.php ENDPATH**/ ?>