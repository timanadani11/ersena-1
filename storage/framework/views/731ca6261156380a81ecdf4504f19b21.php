    ...
    <div class="register-container">
        <div class="register-card">
            ...
            <div class="register-logo">
                <img src="<?php echo e(asset('img/logo/logo.webp')); ?>" alt="Logo SENA" loading="lazy">
            </div>
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data" class="register-form" id="registerForm" autocomplete="off">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="form-grid-compact">
                            <div class="register-form-group">
                                ...
                                <input type="text" id="nombres_completos" name="nombres_completos" required 
                                    value="<?php echo e(old('nombres_completos')); ?>" class="auto-next" 
                            ...
                            <div class="register-form-group">
                                ...
                                <input type="text" id="documento_identidad" name="documento_identidad" required 
                                    value="<?php echo e(old('documento_identidad')); ?>" class="auto-next" 
                            ...
                            <div class="register-form-group">
                                ...
                                <input type="email" id="correo" name="correo" required 
                                    value="<?php echo e(old('correo')); ?>" class="auto-next" 
                        ...
                        <div class="form-grid-compact">
                            <div class="register-form-group">
                                ...
                                <input type="text" id="nombre_programa" name="nombre_programa" required 
                                    value="<?php echo e(old('nombre_programa')); ?>" class="auto-next" 
                            ...
                            <div class="register-form-group">
                                ...
                                <select id="nivel_formacion" name="nivel_formacion" required class="auto-next">
                                    ...
                                    <option value="tecnico" <?php echo e(old('nivel_formacion') == 'tecnico' ? 'selected' : ''); ?>>Técnico</option>
                                    <option value="tecnologo" <?php echo e(old('nivel_formacion') == 'tecnologo' ? 'selected' : ''); ?>>Tecnólogo</option>
                                </select>
                            </div>
                            ...
                            <div class="register-form-group">
                                ...
                                <input type="text" id="numero_ficha" name="numero_ficha" required 
                                    value="<?php echo e(old('numero_ficha')); ?>" class="auto-next" 
                            ...
                            <div class="register-form-group">
                                ...
                                <input type="text" id="numero_ambiente" name="numero_ambiente" required 
                                    value="<?php echo e(old('numero_ambiente')); ?>" class="auto-next" 
                            ...
                            <div class="register-form-group">
                                ...
                                <select id="jornada_id" name="jornada_id" required class="auto-next">
                                    ...
                                    <?php $__currentLoopData = \App\Models\Jornada::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jornada): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($jornada->id); ?>" <?php echo e(old('jornada_id') == $jornada->id ? 'selected' : ''); ?>>
                                            <?php echo e(ucfirst($jornada->nombre)); ?> (<?php echo e(\Carbon\Carbon::parse($jornada->hora_entrada)->format('h:i A')); ?>)
                                        </option>
                        ...
                        <div class="form-grid-compact">
                            <div class="register-form-group">
                                ...
                                <input type="text" id="marca" name="marca" required 
                                    value="<?php echo e(old('marca')); ?>" class="auto-next" 
                            ...
                            <div class="register-form-group">
                                ...
                                <input type="text" id="serial" name="serial" required 
                                    value="<?php echo e(old('serial')); ?>" class="auto-next" 
                ...
                <div class="register-links">
                    <p>¿Ya tienes una cuenta? <a href="<?php echo e(route('login')); ?>">Iniciar Sesión</a></p>
                </div>
            </form>
        </div>
    </div>
...
</html><?php /**PATH C:\laragon\www\ersena\resources\views/auth/register.blade.php ENDPATH**/ ?>